...
import time
import dlib
import cv2			#libraries importing
...
print("starting dlib face detector")
		...
		if EAR < EAR_THRESHOLD:
			...
			if COUNTER >= EAR_CONSECUTIVE_FRAMES:
				...
				cv2.putText(frame, "DROWSINESS ALERT!", (10, 30),
					cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2) #draw an alarm on the frame
